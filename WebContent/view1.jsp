...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<a href = "bbs1.jsp" class="btn btn-primary">목록</a>
				<%
				//글작성자 본인일시 수정 삭제 가능 
					if(userID != null && userID.equals(bbs.getUserID())){
				%>
						<a href="update1.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">수정</a>
						<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction1.jsp?bbsID=<%= bbsID %>" class="btn btn-primary	">삭제</a>
				<%					
					}
				%>
		</div>
