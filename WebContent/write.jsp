...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li><a href="main.jsp">메인</a> <!--현재 접속한 페이지는 메인페이지임을 명시  --></li>
				<li class="active"><a href="bbs.jsp">레시피 게시판</a></li>
				...
				<li><a href="bbs5.jsp">재료가격 예측</a></li>
			</ul>
			<%
				if (userID == null) {
			%>
	...
	<div class="container">
		...
		<table class="table table-striped"
				...
				<tr>
				<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="5026" style="height: 350px;"></textarea></td>
				</tr>
				</tbody>					
				</table>
