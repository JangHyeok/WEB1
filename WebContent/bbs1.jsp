		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="bbs1.jsp">공지 게시판</a></li>
				<li><a href="bbs2.jsp">자유 게시판</a></li>
				<li><a href="bbs3.jsp">질문 게시판</a></li>
				<li><a href="bbs4.jsp">중고거래 게시판</a></li>
				<li><a href="http://janghyeok.iptime.org:8989/">재료가격 예측</a></li>
			</ul>	
				</ul>
				<%
					//라긴안된경우
		...
		<div class="container">
			<div class="row">
				<table class="table table-striped"
					...
					<tbody>
						<%
						BbsDAO1 bbsDAO1 = new BbsDAO1();
						ArrayList<Bbs1> list = bbsDAO1.getList(pageNumber);
							for (int i = 0; i < list.size(); i++) {
						%>
						<tr>
							<td><%=list.get(i).getBbsID()%></td>
							<td><a href="view1.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle()%></a></td>
				...
				<%
					if (pageNumber != 1) {
				%>
				<a href="bbs1.jsp?pageNumber=<%=pageNumber - 1%>"
					class="btn btn-success btn-arrow-left">이전</a>
				<%
					}
					if (bbsDAO1.nextPage(pageNumber)) {
				%>
				<a href="bbs1.jsp?pageNumber=<%=pageNumber + 1%>"
				...
				<%
					...
					if (session.getAttribute("userID") != null) {
				%>
				<a href="write1.jsp" class="btn btn-primary pull-right">글쓰기</a>
				<%
					} else {
				%>
