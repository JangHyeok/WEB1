	...
	<body>
		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse"
				...
				<li class="active"><a href="bbs4.jsp">중고거래 게시판</a></li>
			...
			<div class="row">
				<table class="table table-striped"
					...
					<tbody>
						...
						ArrayList<Bbs4> list = bbsDAO4.getList(pageNumber);
							for (int i = 0; i < list.size(); i++) {
						%>
						<tr>
							<td><%=list.get(i).getBbsID()%></td>
							<td><a href="view4.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle()%></a></td>
				...
				<%
					...
					if (bbsDAO4.nextPage(pageNumber)) {
				%>
				<a href="bbs4.jsp?pageNumber=<%=pageNumber + 1%>"
				...
				<%
					...
					if (session.getAttribute("userID") != null) {
				%>
				<a href="write4.jsp" class="btn btn-primary pull-right">글쓰기</a>
				<%
					} else {
				%>
